...
if __name__ == "__main__":
    ...
    def createRedTemplate():
        global frame
        capture = frame[topx:botx,topy:boty,:]
        cv2.imwrite("", capture)
        print("created red template")
            
    redTemplateButton = tk.Button(window, text="Create Red Template", command=createRedTemplate)
    ...
    greenTemplateButton = tk.Button(window, text="Create Green Template", command=createGreenTemplate)
